...
public class Ball_Script : MonoBehaviour {
    ...
    public GameObject particleCreator;
        ...
        if (gameNotOver) {
            ...
            if (Input.touchCount > 0f)
            {
                ...
                if (touch.phase == TouchPhase.Began) {
                    //Makes the ball jump
                    rb.AddForce(new Vector2(0f, 2f), ForceMode.Impulse);
                }
            }
    ...
    void GameOver() {
        ...
        particleCreator.GetComponent<ParticleCreator>().loadParticles(objectPosition);
